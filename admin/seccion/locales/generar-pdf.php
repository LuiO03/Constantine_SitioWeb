...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // Título
        $this->Cell(0, 10, utf8_decode('Lista de Locales'), 0, 1, 'C');
        $this->Ln(10);

        // Encabezados de la tabla (sin Enlace, Imagen y Acciones)
        ...
        $this->Cell(45, 10, utf8_decode('Dirección'), 1, 0, 'C', true);
        $this->Cell(58, 10, utf8_decode('Horario'), 1, 0, 'C', true);
        $this->Cell(30, 10, utf8_decode('Teléfono'), 1, 1, 'C', true);
    }
...
$consulta = "SELECT id_local, nombre_local, direccion, horario, telefono FROM locales";
...
// Anchura de cada columna (sin Enlace, Imagen y Acciones)
$widths = [18, 40, 45, 58, 30];
...
$nombreArchivo = "Lista_Locales_" . date('Y-m-d_H-i-s') . ".pdf";
