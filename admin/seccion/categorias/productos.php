...
$categoriaID = isset($_GET['categoriaID']) ? $_GET['categoriaID'] : 0;
...
");
$sentencia->bindParam(':categoriaID', $categoriaID, PDO::PARAM_INT);
$sentencia->execute();
...
<!-- INTERFACE PARA PRODUCTOS POR CATEGORÍA -->
...
<div class="card shadow-sm rounded-0">
    <div class="card-header d-flex justify-content-between align-items-center rounded-0" style="color: var(--color_texto); background-color: var(--color_barra_superior);">
        <span class="titulo_categoria d-flex align-items-center gap-1 flex-wrap">
            ...
            Productos en la Categoría: <span class="text_red"><?php echo htmlspecialchars($listaProductos[0]['nombre_categoria'], ENT_QUOTES, 'UTF-8'); ?></span>
        </span>
        <a name="atras" id="atras" class="btn btn-primary d-flex align-items-center gap-1" href="categorias.php" role="button">
            <i class="ri-arrow-left-s-line"></i> Volver a Categorías
        </a>
    </div>
    ...
    <div class="card-footer text-center rounded-0" style="color: var(--color_texto); background-color: var(--color_barra_superior);">
        <small>Gestiona los productos de la categoría: <?php echo htmlspecialchars($listaProductos[0]['nombre_categoria'], ENT_QUOTES, 'UTF-8'); ?></small>
    </div>
</div>
