<?php 
    ...
    if ($_POST) {
        ...
        if (empty($nombre_publico) || strlen($nombre_publico) < 3 || strlen($nombre_publico) > 50) {
            ...
            $sql = "INSERT INTO `publico` (`id_publico`, `nombre_publico`, `descripcion`) 
                    VALUES (NULL, :nombre_publico, :descripcion)";
...
<div class="card shadow-sm mt-4 w-80 mx-auto rounded-0">
    ...
    <div class="card-header d-flex justify-content-between align-items-center rounded-0" style="color: var(--color_texto); background-color: var(--color_barra_superior);">
        <span class="titulo_categoria d-flex align-items-center gap-1 flex-wrap">
            ...
            Agregar <span class="text_red">Público Objetivo</span>
        </span>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 mb-3">
                    <label for="nombre_publico" class="form-label"> 
                        <i class="ri-user-line"></i> Nombre del Público Objetivo
                    </label>
                    <input type="text" class="form-control" name="nombre_publico" id="nombre_publico" placeholder="Escriba el nombre del público objetivo" minlength="3" maxlength="50" required autofocus />
                </div>
                ...
                <div class="col-md-6 col-12 mb-3">
                    ...
                    <textarea class="form-control" name="descripcion" id="descripcion" placeholder="Escriba una breve descripción del público objetivo" minlength="10" maxlength="200" required></textarea>
                </div>
            </div>

            <div class="d-flex justify-content-start gap-3">
                <button type="submit" class="btn btn-success d-flex align-items-center gap-1">
                    <i class="ri-add-circle-line"></i> Crear Público
                </button>
    ...
    <div class="card-footer text-center rounded-0" style="color: var(--color_texto); background-color: var(--color_barra_superior);">
        <small>Gestiona tu público objetivo de forma eficiente</small>
    </div>
</div>
